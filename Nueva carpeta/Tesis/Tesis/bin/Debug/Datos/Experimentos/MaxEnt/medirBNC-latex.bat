...
..\..\..\tesis -comparar "BNC\Taggeado\wsjM1.tt" "BNC\Taggeado\wsjM1+NFI.tt" "BNC\Mediciones\bncMaxEntWSJM2_vs_bncMaxEntWSJM2+NFI.l" -l "BNC etiquetado por MaxEnt (entrenado con 2 mitad WSJ) vs BNC etiquetado con MaxEnt (entrenado con 2 mitad de WSJ + NFI)" "MaxEnt(2WSJ)" "MaxEnt(2WSJ+NFI)" -bnc 
..\..\..\tesis -comparar "BNC\Taggeado\wsjM2.tt" "BNC\Taggeado\wsjM2+NFI.tt" "BNC\Mediciones\bncMaxEntWSJM1_vs_bncMaxEntWSJM1+NFI.l" -l "BNC etiquetado por MaxEnt (entrenado con 1 mitad WSJ) vs BNC etiquetado con MaxEnt (entrenado con 1 mitad de WSJ + NFI)" "MaxEnt(1WSJ)" "MaxEnt(1WSJ+NFI)" -bnc 
