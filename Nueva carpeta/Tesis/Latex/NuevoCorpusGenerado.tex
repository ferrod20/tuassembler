...
A partir del corpus parcialmente anotado obtenido en el proceso de extracción, se completarán las anotaciones automáticamente con un etiquetador gramatical manteniendo las etiquetas gramaticales obtenidas a partir de la información procedente del diccionario Cobuild. Es decir, una vez finalizado el proceso de extracción de información desde el diccionario, se obtiene un corpus nuevo con las etiquetas gramaticales correspondientes a las palabras definiadas en el diccionario. A continuación se exhibe un fragmento del corpus extraído de Cobuild con el formato generado:\\\\
{\small
\noindent A\\
canary	NN\\
is\\
...
\noindent Este es el resultado de extracción, reconocimiento y traducción de etiquetas y formas flexionadas correspondiente a la entrada de Cobuild: 
{\small
\begin{verbatim}
DICTIONARY_ENTRY
k%en*!e*%eri
...
Se puede apreciar que se ha reconocido \emph{canaries} como el plural de \emph{canary} (etiqueta NNS) y que se han reconocido y extraído los ejemplos de estas palabras asignando las etiquetas gramaticales traducidas a partir de las etiquetas del diccionario correspondientes a \emph{canary} (countable noun/NN) y \emph{canaries} (noun/NNS).
