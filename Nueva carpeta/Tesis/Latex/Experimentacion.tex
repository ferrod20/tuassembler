...
\hline
 \backslashbox{\scriptsize{COBUILD}\kern-1em}{\kern-1em \scriptsize{WSJ}} &	\textbf{VBD}	&   \textbf{VBN}	&   \textbf{VBP}	&   \textbf{VB}	&   \textbf{NN}	&   \textbf{JJ}	&   \textbf{VBZ}	&   \textbf{NNS}	&   \textbf{CC}	&   \textbf{NNP}	&   \hline
\endhead
\hline
\endfoot
\endlastfoot
