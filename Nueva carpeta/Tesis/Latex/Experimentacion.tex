...
\hline
 \backslashbox{\scriptsize{COBUILD}\kern-1em}{\kern-1em \scriptsize{TnT}}  &	\textbf{NN}	&   \textbf{VB}	&   \textbf{JJ}	&   \textbf{NN}	&   \textbf{NN}	&   \textbf{JJ}	&   \textbf{VBN}	&   \textbf{JJ}	&   \textbf{RB}	&   \textbf{JJ}	&   \hline
\endhead
\hline
\endfoot
\endlastfoot
