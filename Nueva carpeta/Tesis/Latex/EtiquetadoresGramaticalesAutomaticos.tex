...
A continuación  vamos a presentar 2 tipos de etiquetadores gramaticales: etiquetadores basados en el modelo oculto de \textsl{Markov} o simplemente etiquetadores HMM\footnote{Por las siglas en inglés de Hidden Markov Model} y etiquetadores basados en el modelo de máxima entropía.
