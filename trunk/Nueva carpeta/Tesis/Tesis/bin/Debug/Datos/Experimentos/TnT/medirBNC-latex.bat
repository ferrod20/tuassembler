...
..\..\..\tesis -comparar "BNC\Taggeado\wsjM1.tt" "BNC\Taggeado\wsjM1+NFI.tt" "BNC\Mediciones\bncTnTwsjM2_vs_bncTnTwsjM2+NFI.l" -l "BNC etiquetado por TnT (entrenado con 2 mitad WSJ) vs BNC etiquetado con TnT (entrenado con 2 mitad de WSJ + NFI)" "TnT(2WSJ)" "TnT(2WSJ+NFI)"
..\..\..\tesis -comparar "BNC\Taggeado\wsjM2.tt" "BNC\Taggeado\wsjM2+NFI.tt" "BNC\Mediciones\bncTnTwsjM1_vs_bncTnTwsjM1+NFI.l" -l "BNC etiquetado por TnT (entrenado con 1 mitad WSJ) vs BNC etiquetado con TnT (entrenado con 1 mitad de WSJ + NFI)" "TnT(1WSJ)" "TnT(1WSJ+NFI)"
