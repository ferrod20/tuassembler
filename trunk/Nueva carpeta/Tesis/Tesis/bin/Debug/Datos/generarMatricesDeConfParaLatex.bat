..\tesis -comparar "Entrenamiento\NFI.txt" "Extraccion\Cobuild.tagged" "Mediciones\NFI_VS_CobuildTnTwsj.latexMConf" -l "Matriz de confusión para etiquetas extraídas de COBUILD vs TnT" "COBUILD" "TnT"
..\tesis -comparar "Entrenamiento\NFI.txt" "Extraccion\Cobuild.tagged" "Mediciones\NFI_VS_CobuildTnTwsj.mConf" -p "Matriz de confusión para etiquetas extraídas de COBUILD vs TnT" "COBUILD" "TnT (entrenado con WSJ)"
