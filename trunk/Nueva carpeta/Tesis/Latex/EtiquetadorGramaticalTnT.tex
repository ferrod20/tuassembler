\section{Etiquetador Gramatical TnT} 
...
\end{equation*}
donde $t_1, t_2$ y $t_3$ pertenecen al conjunto de etiquetas y $w_3$ pertenece al lexicon. $N$ es el número de \emph{tokens} del corpus de entrenamiento. La probabilidad de máxima verosimilitud se calcula como cero si el denominador o el nominador son cero.
...
\noindent donde $\hat{P}$ son los estimadores de máxima verosimilitud presentados anteriormente y $\lambda_1$, $\lambda_2$ y $\lambda_3$ son los pesos asociados a estos estimadores, tales que $\lambda_1 + \lambda_2 + \lambda_3 = 1$.
...
\subsection{Manejo de palabras desconocidas}
TnT, al igual que muchos otros etiquetadores gramaticales, maneja las palabras desconocidas mediantes análisis de sufijos. Los sufijos son fuertes predictores del tipo de palabra. Por ejemplo las palabras terminadas en \emph{able} en el corpus \emph{Wall Street Journal} son adjetivos (JJ) en el 98\% de los casos (ej.:\emph{fashionable}, \emph{variable}) y sustantivos (NN) en el 2\% restante.
...
Basándose en el hecho de que las palabras desconocidas son infrecuentes, TnT utiliza sufijos de palabras infrecuentes. Por lo tanto, restringe el procedimiento de cálculo de probabilidades de sufijos a palabras con una frecuencia menor o igual a $10$.
\end{enumerate}
...
Para llevar esto a cabo se utilizan \emph{flags} en las probabilidades contextuales. En lugar de
...
La información presentada en este subcapítulo está basada en \cite{TnT}