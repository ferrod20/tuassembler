...
Las entradas de Cobuild exponen las formas derivadas de la palabra que pueden contener los ejemplos. En el ejemplo presentado anteriormente la palabra es \textsl{bite} y las formas derivadas de \textsl{bite} que muestra la entrada son \textsl{bites, biting, bit} y \textsl{bitten}. Con esta información y la etiqueta que fué anotada en Cobuild (\textsl{verb}) se puede inferir y generar etiquetas de \textsl{Penn Treebank} con información adicional. Como ya se mencionó anteriormente, en este caso la forma \textsl{bites} (derivada de la palabra \textsl{bite}) que aparece en la definición posee la etiqueta \textsl{verb}. La tarea aquí será reconocer que \textsl{bites} es un verbo de tiempo presente en tercera persona singular a partir de que \textsl{bites} está etiquetada como verbo y de que la palabra de la cual deriva es \textsl{bite}. Es decir, inferir el tipo de la forma derivada a partir de la palabra y la etiqueta asignada por Cobuild.
