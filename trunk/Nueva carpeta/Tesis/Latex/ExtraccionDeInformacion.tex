...
Aquí arriba podemos observar una entrada del diccionario para la palabra \textsl{bite}, conteniendo dos ejemplos de esta palabra con sus respectivas etiquetas gramaticales. Podemos notar que en el primer ejemplo la palabra aparece en la forma flexionada; \textsl{bites}. Es decir que la entrada del diccionario nos está ofreciendo más información que la que se observa a simple vista. Se puede apreciar que en el primer ejemplo la palabra aparece en la forma flexionada \textsl{bites} y la entrada asigna la etiqueta \textsl{verb} mientras que en el segundo ejemplo la palabra aparece en su forma regular \textsl{bite} con la misma etiqueta. Reconociendo la forma flexionada (\textsl{bites}) podemos adicionarle información extra a la etiqueta \textsl{verb}, es decir que aparte de guardar la etiqueta \textsl{verb} podemos guardar la información de que ocurre en una forma flexionada.

Las entradas de COBUILD exponen las formas derivadas de la palabra que pueden contener los ejemplos. En el ejemplo presentado anteriormente la palabra es \textsl{bite} y las formas derivadas de \textsl{bite} que muestra la entrada son \textsl{bites, biting, bit} y \textsl{bitten}. Con esta información y la etiqueta que fué anotada en COBUILD (\textsl{verb} en ambos casos) podemos inferir y generar información adicional para las etiquetas asignadas. Como ya se mencionó anteriormente, en este caso la forma \textsl{bites} (derivada de la palabra \textsl{bite}) que aparece en el primer ejemplo posee la etiqueta \textsl{verb}. La tarea aquí será reconocer que \textsl{bites} es un verbo flexionado a partir de que \textsl{bites} está etiquetada como verbo y de que la palabra de la cual deriva es \textsl{bite}. Es decir, inferir el tipo de la forma derivada a partir de la palabra y la etiqueta asignada por Cobuild.
