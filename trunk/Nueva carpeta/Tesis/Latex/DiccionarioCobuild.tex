...
Para cada uno de los ejemplos de una entrada, Cobuild posee información gramatical sobre la palabra definida. Con esta información alcanza para construir un corpus parcialmente anotado. El proceso consiste en pegar o concatenar las palabras de los ejemplos y asignar la etiqueta gramatical correspondiente a la información gramatical que Coubild posee para la palabra asociada. Por ejemplo, en la siguiente entrada Cobuild asigna la información gramatical \textsl{countable noun} para la primer aparición de la palabra (la definición) \textsl{siren} y \textsl{noun} para la segunda (el ejemplo).
