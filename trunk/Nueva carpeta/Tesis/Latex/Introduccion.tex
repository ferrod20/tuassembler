...
(1) \textsl{There is no asbestos in our products now.} \\

El resultado de etiquetarla gramaticalmente es: \\

(2)	\textsl{There/EX is/VBZ no/DT asbestos/NN in/IN our/PRP products/NNS now/RB ./.}\\

donde cada palabra está sucedida por una barra oblicua seguida de la etiqueta gramataical asignada. Se puede apreciar por ejemplo que la palabra \textsl{is} fué etiquetada como VBZ (verbo de tiempo presente en tercera persona singular), \textsl{products} fué etiquetada como NNS (sustantivo plural), étc. Es decir que a cada palabra se le asignó un código que se corresponde con una función gramatical.
